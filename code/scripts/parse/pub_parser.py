...
FIELDS = ['Title', 'URL', 'Year', 'Citations', 'Versions', 'Cluster ID',
          'Citations list', 'Versions list', 'Author line']
...
def parse_pub_file(pub_file):
    ...
    Expected format for publication data is shown in parse_pub_records
    documentation.
    """
    current_record = None
    records = []
